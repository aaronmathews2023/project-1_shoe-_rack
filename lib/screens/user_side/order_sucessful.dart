...
class SucessfulOrder extends StatefulWidget {
  const SucessfulOrder({Key? key});

  @override
  State<SucessfulOrder> createState() => _OrderAcceptState();
}

class _OrderAcceptState extends State<SucessfulOrder> {
  @override
